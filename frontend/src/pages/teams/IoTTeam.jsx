...
import { FaLinkedin, FaGithub, FaMicrochip } from "react-icons/fa";
...
const IoTTeam = () => {
  ...
  return (
    <TeamPageLayout>
      <div className="iot-team-container">
        ...
        >
          <h2>Internet of Things Team</h2>
          <p>
            Connecting the physical and digital worlds through innovative
            solutions
          </p>
        </motion.div>
          ...
          {teamMembers.map((member, index) => (
            ...
            >
              ...
              <div className="member-image">
                <img
                  src={`/team/members/iot/${member.name
                    .toLowerCase()
                    .replace(/\s+/g, "-")}.jpg`}
                  alt={member.name}
                  onError={(e) => {
